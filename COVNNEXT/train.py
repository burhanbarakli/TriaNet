...
from utils.dataloader import get_loader, ValidationDataset
...
if __name__ == '__main__':
    ...
    # Backbone ve Head modüllerini ayır - ConvNeXt backbone için güncellendi
    # ConvNeXt backbone model.net.backbone içinde
    backbone_modules = [
        model.net.backbone  # ConvNeXt backbone tamamı
    ]
    ...
    head_modules = [
        ...
        model.net.final_up,  # FinalUpBlock eklendi
        ...
        model.net.gabor_layer, model.net.feature_fusion_conv,  # Gabor ve fusion conv eklendi
        model.net.fusion_conv1, model.net.fusion_conv2, model.net.fusion_conv3, model.net.fusion_conv4
    ]
