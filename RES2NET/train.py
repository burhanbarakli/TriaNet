...
def train(train_loader, model, optimizer, epoch, criteria_loss, total_step, opt):
    model.train()
...
if __name__ == '__main__':
    ...
    for epoch in range(start_epoch, opt.epoch):
        ...
        # 1. Training
        avg_loss = train(train_loader, model, optimizer, epoch, criteria_loss, total_step, opt)
