...
class EGANet(nn.Module):
    def __init__(self, n_channels, n_classes):
        ...
        self.up5 = nn.Sequential(
            # Önce özellikleri aynı ölçekte işle
            Conv(512, 512),
            # Ardından ConvTranspose2d ile boyutu 2 katına çıkar
    ...
    def forward(self, x):
        ...
        #Decoder - ÇALIŞAN VERSİYON MANTIĞI
        ...
        ega1 = self.ega1(laplacian_feature, e1, out2)
        pattern_out1 = self.pat_att1(gabor_features, e1)
