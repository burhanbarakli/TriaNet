...
def main():
    ...
    parser.add_argument('--pth_path', type=str, default='./checkpoints/bb/bb-Res2Net_augment_az_train_py/bb_res2net_ep060_loss1.0662_dice0.9179.pth')
    parser.add_argument('--test_root_base', type=str, default='./dataset/TestDataset')
    parser.add_argument('--save_root_bin', type=str, default='./results/res2net_az_augment_bin')
    parser.add_argument('--save_root_prob', type=str, default='./results/res2net_az_augment_prob')
